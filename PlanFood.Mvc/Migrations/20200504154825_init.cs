        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DayNameId = table.Column<int>(nullable: false),
                    DisplayOrder = table.Column<int>(nullable: false),
                    MealName = table.Column<string>(maxLength: 245, nullable: false),
                    PlanId = table.Column<int>(nullable: false),
                    RecipeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipePlans", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RecipePlans_DayNames_DayNameId",
                        column: x => x.DayNameId,
                        principalTable: "DayNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipePlans_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipePlans_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "67709d68-b356-442f-95c4-bc4089f445e7", "Admin", "Admin" },
                    { 2, "7e3a4868-c2e0-46e8-a667-e6ede9a53b51", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipePlans_DayNameId",
                table: "RecipePlans",
                column: "DayNameId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipePlans_PlanId",
                table: "RecipePlans",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipePlans_RecipeId",
                table: "RecipePlans",
                column: "RecipeId");
